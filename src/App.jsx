    ...
    <div className="app">
      <BrowserRouter>
        ...
        <Routes>
          ...
          {/* Warehouse routes */}
          <Route path="/warehouses" element={<Warehouses warehouses={warehouses} getWarehouses={getWarehouses()} />} />
          ...
          {/* Inventory routes */}
          <Route path="/inventory" element={<Inventory inventories={inventories} warehouses={warehouses} getInventories={getInventories()} />} />
